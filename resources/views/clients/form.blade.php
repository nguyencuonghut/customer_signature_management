<div class="container-fluid">
    ...
    <div class="row">
        <div class="form-group col-md-6">
            {!! Form::label('name', __('Tên'), ['class' => 'control-label']) !!} <span class="text-danger">*</span>
            {!! Form::text('name', $data['name'] ?? null, ['class' => 'form-control']) !!}
        </div>
        <div class="form-group col-md-6">
            {!! Form::label('code', __('Code'), ['class' => 'control-label']) !!} <span class="text-danger">*</span>
            {!! Form::text('code', $data['code'] ?? null, ['class' => 'form-control']) !!}
        </div>
    </div>
...
-->
    ...
    <div class="row">
        <div class="form-group col-sm-6">
            {!! Form::label('primary_number', __('Số điện thoại'), ['class' => 'control-label']) !!} <span class="text-danger">*</span>
        ...
        -->
        <div class="form-group col-sm-6">
            {!! Form::label('address', __('Địa chỉ'), ['class' => 'control-label']) !!} <span class="text-danger">*</span>
            {!! Form::text('address', $data['address'] ?? null, ['class' => 'form-control']) !!}
        </div>
    </div>
    <div class="row">
        <div class="form-group col-sm-12">
            {{ Form::label('signature_path', __('Chữ ký'), ['class' => 'control-label']) }} <span class="text-danger">*</span>
            {!! Form::file('signature_path',  null, ['class' => 'form-control']) !!}
        </div>
    </div>
