    ...
    <nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas-sm" role="navigation">
        <div class="list-group panel">
            ...
            <a href="#clients" class=" list-group-item" data-toggle="collapse" data-parent="#MainMenu"><i
                        class="sidebar-icon fa fa-users"></i><span id="menu-txt">{{ __('Khách hàng') }}</span>
            ...
            <div class="collapse" id="clients">
                ...
                @if(Entrust::can('client-create'))
                    <a href="{{ route('clients.create')}}"
                       class="list-group-item childlist">{{ __('Tạo mới khách') }}</a>
                @endif
                @if(Entrust::can('client-create'))
                    <a href="{{ route('clients.import')}}"
                       class="list-group-item childlist">{{ __('Import khách') }}</a>
                @endif
            </div>
